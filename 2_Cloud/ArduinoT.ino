...
const int motor = A0; //Remenber to change the function ! 
const int soil = A5 ; 
const int buzzer = 8 ;
...
/*
  Since HandleMotor is READ_WRITE variable, onHandleMotorChange() is
  executed every time a new value is received from IoT Cloud.
*/
void onHandleMotorChange()  {
  // Add your code here to act upon HandleMotor change
}